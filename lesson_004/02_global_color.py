...
def user_input():
    ...
    print('Выбирете желаемый цвет для фигур:\n1 : красный \n2 : оранжевый \n3 : желтый \n4 : зеленый \n5 : '
          'сине-зеленый \n6 : синий \n7 : фиолетовый\n')
    while True:
        color = input('Введите желаемй цвет: ')  # TODO название лучше подобрать другое, user_input например
    ...
    # TODO пока число не окажется правильным
        if color in colors:
            color = colors['{0}'.format(color)]  # TODO формат тут не нужен
            print(color)  # TODO сейчас вы передаете {'color_name': 'yellow', 'sd_name': (255, 255, 0)}
